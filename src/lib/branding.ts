...
// 全站默认会注入的品牌相关关键词
// 覆盖核心搜索词：Gemini 3 / gemini3 / Gempix2 / Gempix 2 / Nano Banana 2
...
export const DEFAULT_SEO_DESCRIPTION = `${DISPLAY_BRAND} is an English hub for Gemini 3, Gemini 3.0 and gemini3 guides, tutorials, prompt libraries, and image workflows that connect to Gempix2 (Gempix 2) running on the Nano Banana 2 stack.`;
